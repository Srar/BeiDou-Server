...
import static org.gms.server.bot.attack.BotAttackProfile.magic;
import static org.gms.server.bot.attack.BotAttackProfile.magicAoe;
import static org.gms.server.bot.attack.BotAttackProfile.melee;
import static org.gms.server.bot.attack.BotAttackProfile.meleeAoe;
import static org.gms.server.bot.attack.BotAttackProfile.meleeAoeVar;
import static org.gms.server.bot.attack.BotAttackProfile.meleeMultiVar;
import static org.gms.server.bot.attack.BotAttackProfile.meleeVar;
import static org.gms.server.bot.attack.BotAttackProfile.ranged;
import static org.gms.server.bot.attack.BotAttackProfile.rangedAoe;
...
public final class BotAttackConfig {
    ...
    static {
        ...
        // 两份 WZ 数据集（SoloMapling 与 gms）的 Skill.wz/100.img.xml 均为 1001xxx 旧式 id，
        // POWER_STRIKE=1001004 / SLASH_BLAST=1001005；常量已对齐数据集。
