...
/**
 * Maple Messenger 命令（SoloMapling BotCommandsPack.MapleMessengerCommands 逐行移植）。
 * <p>
 * gms 已有 {@link Messenger}/{@link MessengerCharacter}/{@link InviteCoordinator}，
 * 签名与 SoloMapling 一致，按 gms 包路径适配即可。
 */
public class MapleMessengerCommands {
    ...
    public static void botSendChatFull(Character fakechar, String message, long milliseconds) {
        ...
        BotHelpers.blockingSleep(milliseconds);
