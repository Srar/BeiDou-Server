...
import org.gms.server.bot.replay.StartEndPair;
import org.gms.server.bot.replay.TimeCoordinatePair;
import org.gms.server.bot.freemarket.BotRand;

import org.gms.server.bot.BotLogic;
import org.gms.server.bot.replay.PlayerReaction;
import org.gms.server.bot.replay.PlayerSnapshot;
...
import static org.gms.server.bot.replay.MovementCommands.MidMovementCheck;
import static org.gms.server.bot.replay.MovementCommands.executeMovement;
import static org.gms.server.bot.replay.navigation.NavigationElement.parseNavigationType;
...
//        List<String> connectors = gr.getConnectorOfPoint(endPoint); //  gr.getMainAreaOfPoint(endPoint)
        ...
        String mainArear = BotRand.getRandomElement(mainAreas);
        String endArea = BotRand.getRandomElement(endAreas);
