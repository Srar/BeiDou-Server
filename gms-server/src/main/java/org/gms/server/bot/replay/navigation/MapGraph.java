...
public class MapGraph {
    ...
    public MapGraph(int mapId) {
        ...
        this.directory = new File("movementDataPackets/map" + this.mapId);
        this.setMainAreas();
        this.setConnectors();
        this.buildGraph();
    }
...
//        printGraphNodesVertices();
    ...
    public List<GraphPath<String, NamedEdge>> getAllPaths(String startNode, String endNode, int maxPathLength) {
        ...
        try {
            ...
            log.debug("MapGraph.getAllPaths failed for map {} ({} -> {})", mapId, startNode, endNode, e);
            return null;
        }
    }
...
//            }
        ...
        try {
            ...
            log.debug("MapGraph.getRandomPath failed for map {} ({} -> {})", mapId, startNode, endNode, e);
            return null;
        }
    }
