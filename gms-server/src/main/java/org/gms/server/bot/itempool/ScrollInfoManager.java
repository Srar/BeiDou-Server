...
/**
 * 移植自 SoloMapling {@code soloMapling.itemPool.ScrollInfoManager}。
 *
 * <p>适配点：{@code client.inventory.Equip / constants.inventory.EquipType /
 * server.ItemInformationProvider} → gms 对应包（{@code org.gms.client.inventory /
 * org.gms.constants.inventory / org.gms.server}），API 签名一致；其余逻辑与源一致。
 */
