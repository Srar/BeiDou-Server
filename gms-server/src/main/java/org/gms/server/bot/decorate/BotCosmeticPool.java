...
public class BotCosmeticPool {
    ...
    // NOTE: comment in SoloMapling says "0.5% = 1 in 200" but the code value is 0.01 (1%);
    // kept the code value (0.01) verbatim per porting rules.
    private static final double WILD_CHANCE = 0.01;
