 ...
 *
 * <p>移植自 SoloMapling {@code soloMapling.itemPool.EquipOmitList}。
 * 适配点：源用 yamlbeans 读源树文件路径，gms 改为 snakeyaml + classpath 资源
    ...
    public static synchronized void load() {
        ...
        try {
            ...
            try (InputStream stream = in) {
                root = (Map<String, Object>) new Yaml().load(stream);
            }
