...
/**
 * 移植自 SoloMapling {@code soloMapling.itemPool.ScrollPatternGenerator}。
 *
 * <p>适配点：{@code MapleVersionManager.getVersion()} → {@code ServerConstants.VERSION}
 * （v83 ≥ 40，恒走 40+ 卷轴模式，与源 v55 行为一致）；其余逻辑与源一致。
 */
