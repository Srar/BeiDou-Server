...
import static org.gms.server.bot.BotLogic.generateCleanItemWithQty;
...
//        todo
    ...
    public static int readPartnerMeso(Character fakechar) {
        if (isValidTrade(fakechar)) {
            ...
            log.debug("partnerMeso: {}", partnerMeso);
            return partnerMeso;
        }
        return 0;
    }
    ...
    public static List<Integer> getOccupiedTradeSlots(Character fakechar) {
        if (isValidTrade(fakechar)) {
            ...
            log.debug("occupiedPositions: {}", occupiedPositions);
    ...
    public static List<Integer> getEmptyTradeSlots(Character fakechar) {
        if (isValidTrade(fakechar)) {
            ...
            log.debug("emptySlots: {}", emptySlots);
            return emptySlots;
        }
        return List.of();
    }
    ...
    public static boolean isPartnerLocked(Character fakechar) {
        if (isValidTrade(fakechar)) {
            ...
            log.debug("partnerLocked: {}", partnerLocked);
