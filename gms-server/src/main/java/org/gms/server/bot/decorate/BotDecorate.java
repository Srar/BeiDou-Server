...
//        }
    ...
    public static void setBotVariables(Character bot) {
        ...
        if (isEquipCacheReady()) {
            // Full class-aware decoration is an in-memory lookup now, so it
    ...
    private static boolean hasClothing(Character bot) {
        ...
        return equipped.getItem((short) -5) != null  // coat/overall
                || equipped.getItem((short) -6) != null; // pants
    }
     ...
     */
    private static boolean isEquipCacheReady() {
        return true;
    }
