package org.gms.server.bot.travel;
...
public final class BotScriptedWarp {
    ...
    // gms 移植：SoloMapling 的 MapleVersionManager.isPortalinCurrentVersion 未移植；版本门暂时恒 true。
    // TODO(P5-?): 待 MapleVersionManager 落地后恢复版本门控。
    private static boolean isPortalinCurrentVersion(int toMapId) {
        return true;
    }
