...
/**
 * 移植自 SoloMapling {@code soloMapling.itemPool.ScrolledItemComparator}。
 *
 * <p>适配点：{@code soloMapling.FreeMarket.EquipListGenerator.generateCleanItemEquip}
 * → gms 既有等价物 {@code org.gms.server.bot.BotLogic.generateCleanItemEquip}
 * （同签名：ItemInformationProvider.getEquipById / 非装备兜底 Item），其余逻辑与源一致。
 */
